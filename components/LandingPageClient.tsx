    ...
    <div className="min-h-screen bg-[#212121] text-gray-50 font-sans selection:bg-gray-700 overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-[#212121]/80 border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          {/* 🚀 Updated Logo: No icon, larger text, crisp layout */}
          <div className="flex items-center font-bold text-2xl tracking-tighter cursor-default">
      ...
      <main className="pt-32 pb-20 px-6 max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed">
          Run advanced Vision Transformers and Large Language Models entirely in
          your browser. Zero cloud dependency. Zero latency. Absolute privacy.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          ...
          <a
            href="https://github.com/MahimVyas/ODM-LLM"
            target="_blank"
            rel="noreferrer"
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#2F2F2F] hover:bg-[#3F3F3F] border border-white/10 text-white px-8 py-4 rounded-full font-semibold transition-all"
          >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#212121] p-8 rounded-3xl border border-white/5 hover:border-white/20 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Your data never leaves your device. Models are downloaded and
                cached locally, ensuring enterprise-grade security for sensitive
                information.
              </p>
            </div>
            ...
            <div className="bg-[#212121] p-8 rounded-3xl border border-white/5 hover:border-white/20 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                By bypassing server round-trips, inference happens in real-time
                utilizing your device's native Neural Engine and WebGPU.
              </p>
            </div>
            ...
            <div className="bg-[#212121] p-8 rounded-3xl border border-white/5 hover:border-white/20 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Upload images for instant local classification and analysis,
                seamlessly feeding context into the local LLM reasoning engine.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-[#212121] border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 text-lg mb-12 max-w-2xl mx-auto">
            Engineered using cutting-edge browser APIs and modern web frameworks
            to deliver native-like AI performance.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-500 text-sm mt-1">
              &copy; {new Date().getFullYear()} ODM. Released under the MIT
              License.
            </p>
          </div>
